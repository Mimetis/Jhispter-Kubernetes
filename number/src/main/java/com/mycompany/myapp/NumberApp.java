...
public class NumberApp {
    ...
    private static final Logger log = LoggerFactory.getLogger(NumberApp.class);

    private final Environment env;

    public NumberApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(NumberApp.class);
