...
public class ContosoApp {
    ...
    private static final Logger log = LoggerFactory.getLogger(ContosoApp.class);

    private final Environment env;

    public ContosoApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(ContosoApp.class);
